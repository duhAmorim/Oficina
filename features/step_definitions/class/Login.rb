...
class Login 
    ...
    def Login.preencherCampos(usuario,senha)
        
        find('#username').set usuario #O .set indica que vamos inserir dados neste elemento e após coloco o valor a ser inserido por meio da variavel usuario
